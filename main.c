...
if(operazione == 3){
printf("%s %f 
", "il risultato della moltiplicazione  è :  ", result)moltiplicazione(numA,numB,&result);
}
if(operazione == 2){
printf("%s %f 
", "il risultato della sottrazione  è :  ", result)sottrazione(numA,numB,&result);
}
if(operazione == 1){
printf("%s %f 
", "il risultato della somma  è :  ", result)somma(numA,numB,&result);
}
printf("inserisci il secondo numero");
scanf("%f",&numB);printf("inserisci il primo numero");
scanf("%f",&numA);numA = 0.0;
numB = 0.0;
result = 0.0;
}
...
while (condizione == 1){
printf("null");
scanf("%d",&condizione);printf("%s 
", "vuoi continuare? scrivi 1, vuoi stopparti scrivi 0")if(operazione == 1 || operazione == 2 || operazione == 3 || operazione == 4){
elaboraScelta(operazione);
}
printf("inserisci la tua scelta qui (1,2,3,4)");
scanf("%d",&operazione);printf("%s 
", "se vuoi fare la divisione  scrivi 4 ")printf("%s 
